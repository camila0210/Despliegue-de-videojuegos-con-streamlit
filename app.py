...
Original file is located at
    https://colab.research.google.com/drive/1GmDozrvmUvceuErOGNGRKvA7Qo5Wba9c
...
Edad = st.slider('Edad', min_value=14, max_value=52, value=20, step=1)#Barra
videojuego = st.selectbox('Videojuego', ["'Mass Effect'","'Battlefield'", "'Fifa'","'KOA: Reckoning'","'Crysis'","'Sim City'","'Dead Space'","'F1'"])#Selector
Plataforma = st.selectbox('Plataforma', ["'Play Station'", "'Xbox'","PC","Otros"])#Selector
Sexo = st.selectbox('Sexo', ['Hombre', 'Mujer'])#Selector
Consumidor_habitual = st.selectbox('Consumidor_habitual', ['True', 'False'])#Selector
...
data_preparada[['Edad']]= min_max_scaler.transform(data_preparada[['Edad']]) #PORQUE GUARDÉ KNN
data_preparada.head()
